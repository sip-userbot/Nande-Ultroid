...
async def autopilot():
    ...
    if not channel:
        ...
        try:
            r = await ultroid_bot(
                CreateChannelRequest(
                    title="My Ayra Logs",
                    about="My Ayra Log Group\n\n Created by @riizzvbss",
                    megagroup=True,
                ),
            )
    ...
    if isinstance(chat.photo, ChatPhotoEmpty):
        photo = await download_file(
            "https://graph.org/file/098f5964288af38f0f343.jpg", "logo.jpg"
        )
...
async def customize():
    ...
    try:
        ...
        file = random.choice(
            [
                "https://graph.org/file/098f5964288af38f0f343.jpg",
                "https://graph.org/file/098f5964288af38f0f343.jpg",
...
• Here, are the Some Basic stuff from, where you can Know, about its Usage."""
        PHOTO = "https://graph.org/file/098f5964288af38f0f343.jpg"
